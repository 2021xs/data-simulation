...
段长审计表输出到 `outputs/metrics/m2_segment_local_tservice_confirm_segment_audit.csv`。
...
|:--------------|--------------:|
| M2_block_30s  |     0.0888889 |
| M2_block_120s |     0.133333  |
...
|:------------------------|--------------:|
| single-window           |      0.111111 |

完整 summary 输出到 `outputs/metrics/m2_segment_local_tservice_confirm_summary_raw.csv`；heatmap input 输出到 `outputs/metrics/m2_segment_local_tservice_confirm_heatmap_input.csv`。
...
- Dataset: `outputs/datasets/m2_segment_local_tservice_confirm_dataset.csv`
- Summary: `outputs/metrics/m2_segment_local_tservice_confirm_summary_raw.csv`
- Segment audit: `outputs/metrics/m2_segment_local_tservice_confirm_segment_audit.csv`
- Heatmap input: `outputs/metrics/m2_segment_local_tservice_confirm_heatmap_input.csv`
- Report: `outputs/reports/m2_segment_local_tservice_confirm_raw_report.md`
- Figures: `outputs/figures/m2_segment_local_tservice_confirm/segment_duration_audit.png, outputs/figures/m2_segment_local_tservice_confirm/attack_model_dwell_comparison.png, outputs/figures/m2_segment_local_tservice_confirm/tservice_sensitivity.png, outputs/figures/m2_segment_local_tservice_confirm/rho_sensitivity_m2_block.png, outputs/figures/m2_segment_local_tservice_confirm/bk_ablation_m2_block.png, outputs/figures/m2_segment_local_tservice_confirm/window_aware_vs_single_m2_block.png`
