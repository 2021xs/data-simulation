...
- target 数：`20`
- benign sequence 数：`1000`
- attack sequence 数：`800`
- group 行数：`285240`
...
| --- | --- | --- | --- | --- | --- | --- |
| naive_accumulation | 0.4245 | 0.5659 | 0.0095 | 0.0171 | 0.1315 | 0.8514 |
| proposed_accumulation | 0.4146 | 0.5578 | 0.0276 | 0.0073 | 0.0577 | 0.9350 |
| single_window | 0.9793 | 0.0148 | 0.0059 | 0.2729 | 0.1206 | 0.6065 |

## 8. benign 三态结果

在 `p95 + proposed_accumulation` 下，benign ACCEPT 约 `0.4146`，DEFER 约 `0.5578`。DEFER 是本轮设计中可接受的不确定输出，后续可由更多窗口或多 pass 累计继续处理。

## 9. attack 三态结果

`p95` 平均 attack accept rate：single-window `0.2729`，naive accumulation `0.0171`，proposed accumulation `0.0073`。如果 proposed 低于 naive，说明 joint b/k fitting 与异常门限对累计攻击样本有过滤作用。

## 10. 三类攻击对比

| attack_type | attack_accept_rate | attack_defer_rate | attack_reject_rate |
| --- | --- | --- | --- |
| same_plane_altitude_offset | 0.0138 | 0.0767 | 0.9096 |
| inclination_offset | 0.0059 | 0.0902 | 0.9038 |
...
| --- | --- | --- | --- |
| best_attack_segments | 0.0094 | 0.0973 | 0.8933 |
| full_pass | 0.0125 | 0.0025 | 0.9850 |
| middle | 0.0263 | 0.0000 | 0.9738 |
| middle_segments | 0.0061 | 0.0398 | 0.9541 |
| spread_segments | 0.0039 | 0.0475 | 0.9486 |
...
- `outputs/datasets/window_aware_evidence_accumulation_dataset.csv`
- `outputs/metrics/window_aware_evidence_accumulation_summary.csv`
- `outputs/metrics/window_aware_strategy_comparison.csv`
- `outputs/reports/window_aware_evidence_accumulation_summary.md`
- `outputs/figures/strategy_attack_accept_rate_comparison.png`
- `outputs/figures/strategy_benign_accept_defer_comparison.png`
- `outputs/figures/accumulation_by_segment_pattern.png`
- `outputs/figures/attack_type_under_accumulation.png`
- `outputs/figures/evidence_score_distribution.png`
- `outputs/figures/joint_bk_gate_effect.png`
